...
static constexpr theta_sens_type theta_sensors_id_list[ID_TABLE_LEN] =
{
		...
		// ID (64 bit)								     StaionType RelayNo	Shortname (5 bytes)
		{  0x28, 0xFF, 0x89, 0x0E, 0x02, 0x17, 0x03, 0x4A,	0,		1,    	'I','N','N','E','N', '\0'},
		{  0x28, 0xFF, 0x45, 0xB1, 0xC2, 0x17, 0x01, 0xAD,	1,		1,    	'W','S','T','_','O', '\0'},
		{  0x28, 0xFF, 0x10, 0xC4, 0xC0, 0x17, 0x01, 0x8C,	1,		1,    	'W','S','T','_','U', '\0'},
		{  0x28, 0xFF, 0x76, 0xC7, 0xC0, 0x17, 0x01, 0x89,	1,		2,		'G','G','E','_','O', '\0'},
		{  0x28, 0xFF, 0xAB, 0xB0, 0xC2, 0x17, 0x01, 0x5A,	1,		2, 		'G','G','E','_','U', '\0'},
		{  0x28, 0xFF, 0xC4, 0xAD, 0xC2, 0x17, 0x01, 0x81,	1,		0, 		'A','S','N','_','O', '\0'},
		{  0x28, 0xFF, 0xA6, 0x40, 0xC0, 0x17, 0x02, 0x6A,	1,		0, 		'G','G','E','_','V', '\0'},
		{  0x28, 0xFF, 0x34, 0x99, 0xC0, 0x17, 0x01, 0x2E,	2,		1, 		'L','G','R','_','O', '\0'},
		{  0x28, 0xFF, 0x38, 0x17, 0x60, 0x17, 0x05, 0x54,	2,		1, 		'L','G','R','_','U', '\0'},

		// nicht zugeteilt:
		{  0x28, 0xFF, 0x99, 0xC1, 0xC0, 0x17, 0x01, 0x35,	1,		0, 		'U','N','K','N','O', '\0'},
		{  0x28, 0xFF, 0x03, 0xB7, 0xC2, 0x17, 0x01, 0xD1,	1,		0, 		'U','N','K','N','O', '\0'},
		{  0x28, 0xFF, 0x75, 0x82, 0xC2, 0x17, 0x01, 0xE9,	1,		0, 		'U','N','K','N','O', '\0'}
