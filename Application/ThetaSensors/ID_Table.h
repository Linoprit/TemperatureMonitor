...
static constexpr theta_sens_type theta_sensors_id_list[ID_TABLE_LEN] =
{
		...
		{  0x28, 0xFF, 0x10, 0xC4, 0xC0, 0x17, 0x01, 0x8C,	2,		1,    	'W','S','T','_','U', '\0'},
		{  0x28, 0xFF, 0x76, 0xC7, 0xC0, 0x17, 0x01, 0x89,	2,		1,		'G','G','E','_','O', '\0'},
		{  0x28, 0xFF, 0xAB, 0xB0, 0xC2, 0x17, 0x01, 0x5A,	2,		1, 		'G','G','E','_','U', '\0'},
		...
		{  0x28, 0xFF, 0x03, 0xB7, 0xC2, 0x17, 0x01, 0xD1,	-50,	0, 		'U','N','K','N','O', '\0'},
