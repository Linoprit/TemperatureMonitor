...
NRF24L01::NRF24L01(Spi_socket* spi_socket, NRF24L01_GPIO* gpio_socket)
{
	this->spi_socket 	= spi_socket;
	this->gpio_socket 	= gpio_socket;
}
...
NRF24L01::nRF24_TXResult NRF24L01::TransmitPacket(uint8_t *pBuf, uint8_t length)
{
